  ...
  return (
    <div className="bg-[#f8fbfa] min-h-screen w-full">
      <div className="w-full">
        ...
        {/* Sekcja z kartą */}
        <div className="bg-white mt-20 max-w-4xl mx-auto rounded-lg shadow-md p-6 relative z-10 flex flex-col items-center">
          <div className="relative w-full flex justify-center">
            <img
              src={pageData.photo_url}
              alt="Zdjęcie"
              className="w-48 h-48 object-cover rounded-md shadow-md border-4 border-white absolute -top-24"
            />
          </div>
